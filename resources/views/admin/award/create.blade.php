  @component('admin.layouts.content', [
      'title' => 'ثبت لوگو فوتر',
      'tabTitle' => 'ثبت لوگو فوتر',
      'breadcrumb' => [['title' => 'لیست لوگوهای فوتر', 'url' => route('admin.award.index')], ['title' => 'ایجاد لوگو فوتر ',
      'class' => 'active']],
      ])
	...
	<div class="col-md-8">
		...
		<div class="card card-custom gutter-b example example-compact">
			<div class="card-header">
                ...
                <h3 class="card-label">ثبت لوگو فوتر</h3>
				</div>
			</div>
			<!--begin::Form-->


            <form class="forms-sample" method="POST" action="{{ route('admin.award.store') }}"   id="kt_form"   enctype="multipart/form-data" >
                @csrf
				<div class="card-body">
                    ...
                    @include('admin.layouts.table.avatar', [  'avatarimage' => '' , 'class'=>'image-input-wrapper' , 'style' => '' , 'id_av' => '1'  , 'label' => 'آپلود لوگو فوتر    '  ])
