  @component('admin.layouts.content', [
      'title' => 'ویرایش بلاگ',
      'tabTitle' => ' ویرایش بلاگ',
      'breadcrumb' => [['title' => 'لیست بلاگها', 'url' => route('admin.blog.index')], ['title' => 'ویرایش بلاگ  ',
      'class' => 'active']],
      ])
	...
	<div class="col-md-12">
		...
		<div class="card card-custom gutter-b example example-compact">
			<div class="card-header">
                ...
                <h3 class="card-label">  ویرایش بلاگ </h3>
				</div>
			</div>
			<!--begin::Form-->


            <form class="forms-sample" method="POST" action="{{ route('admin.blog.update', $blog) }}"   id="kt_form"  enctype="multipart/form-data" >
                @csrf
				<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-lg-10 col-md-10 col-sm-12">
                    <textarea class="summernote" name="text"   id="kt_summernote_1"     rows="12">{{$blog->text}}</textarea>
				</div>
			</div>


                    @include('admin.layouts.table.avatar', [  'avatarimage' => $blog->image , 'class'=>'image-input-wrapper' , 'style' => '' , 'id_av' => '1'  , 'label' => 'آپلود عکس بلاگ'  ])
