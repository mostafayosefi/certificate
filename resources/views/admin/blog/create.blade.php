  @component('admin.layouts.content', [
      ...
      'tabTitle' => 'ایجاد بلاگ جدید',
      'breadcrumb' => [['title' => 'لیست بلاگهای سایت', 'url' => route('admin.blog.index')], ['title' => 'ایجاد بلاگ جدید',
      'class' => 'active']],
      ])
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="card card-custom gutter-b example example-compact">
			<div class="card-header">
                ...
                <h3 class="card-label">  ایجاد بلاگ جدید </h3>
				</div>
			</div>
			<!--begin::Form-->


            <form class="forms-sample" method="POST" action="{{ route('admin.blog.store') }}"   id="kt_form"   enctype="multipart/form-data" >
                @csrf
				<div class="card-body">
  ...
  @include('admin.layouts.table.avatar', [  'avatarimage' => '' , 'class'=>'image-input-wrapper' , 'style' => '' , 'id_av' => '1'  , 'label' => 'آپلود عکس بلاگ  '  ])
