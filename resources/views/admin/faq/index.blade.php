@component('admin.layouts.content', [
    ...
    'breadcrumb' => [['title' => 'مشاهده سوالات متداول', 'class' => 'active']],
    ])
     ...
     <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">  لیست سوالات متداول  </h3>
            </div>
            <div class="card-toolbar">

                 <a href="{{ route('admin.faq.create') }}" class="btn btn-primary font-weight-bolder">
                    <i class="la la-plus"></i>ایجاد سوال </a>
             </div>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    @foreach ($faqs as $key => $admin)
                        <tr>
                            ...
                            <td nowrap="">
                                <a href="{{ route('admin.faq.edit', $admin) }}" class="btn btn-icon btn-outline-primary btn-circle btn-sm mr-2">
