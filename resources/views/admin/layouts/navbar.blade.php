...
{{--
  ...
  --}}
                            ...
                            <div class="topbar-item" style="display: block;">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                    id="kt_quick_user_toggle">
                                    <span
                                        class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">پروفایل</span>
                                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                        <span class="symbol-label font-size-h5 font-weight-bold">مدیر</span>
                                    </span>
                                </div>
                            </div>
                ...
                <!--end::Header-->
                    		...
                    		<!-- begin::User Panel-->
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10"  style="display: block;">
	<!--begin::Header-->
...
@endif
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <circle fill="#000000" opacity="0.3" cx="18.5" cy="5.5" r="2.5"/>
		    ...
		    <!--begin::Item-->
		    <a href="{{route('admin.contact.index')}}"  class="navi-item">
		        <div class="navi-link">
					<div class="symbol symbol-40 bg-light mr-3">
						<div class="symbol-label">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" opacity="0.3" x="17" y="11" width="3" height="6" rx="1.5"/>
		            ...
		            <div class="navi-text">
		                <div class="font-weight-bold">
		                    پیام های من
 <span class="label label-light-primary label-rounded font-weight-bold">{{$unread_contact}}</span>
...
<form method="POST" action="{{route('admin.profile.logout')}}">
    @csrf
    @method('PUT')
    <button type="submit"  class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">خروج
    </button>
</form>
