...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">  لیست متن های پیش فرض  </h3>
        </div>
    ...
    <div class="card-body">
         <table class="table table-separate table-head-custom table-foot-custom table-checkable" id="kt_datatable">
            ...
            <tbody>
                ...
                <td>{{$admin->title}}</td> 
                        <td nowrap="">
                            <a href="{{ route('admin.setting.txtdes_management_edit', $admin) }}" class="btn btn-icon btn-outline-primary btn-circle btn-sm mr-2">
                                <i class="flaticon2-pen"></i></a>  </td>
                    </tr>
                @endforeach
